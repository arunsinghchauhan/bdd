								...
								<th width="550" height="367" valign="top" scope="col"
									align="center">
										...
										<table width="546" border="1"
											...
											String sql="select *  from faculty_registration_tbl";
											...
											<tr>
											    <td align="left">
											    <a href="delFacultyRecordById.jsp?facultyId=<%=rs.getString(1)%>"><img src="images/close.png"/>
											    </a>
											    
											    <a href="editFacultyRecordById.jsp?facultyId=<%=rs.getString(1)%>"><img src="images/edit.png"/>
											    </a>

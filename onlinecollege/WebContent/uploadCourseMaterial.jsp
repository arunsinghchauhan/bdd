<%-- 
    Document   : uploadCourseMaterial
    Created on : Jan 31, 2013, 5:13:03 PM
    Author     : access
--%>
    ...
    <body>
          ...
          <div class="whitecontant">
                ...
                <div style="height: 300px; width: 99.50%; border: 1px solid gray">
                     ...
                     <form enctype="multipart/form-data" action="MaterialAuth" method="POST">                <center>


                            <fieldset style="border-radius:10px; background:rgba(67, 148, 217, 0.1); width: 300px; padding: 10px; height: auto">
                                <legend>Upload Course Material</legend>
                    ...
                    <tr>
                        <td align="center"><b>Upload Materials</b></td><td>:</td>
                        <td align="left">

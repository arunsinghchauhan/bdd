...
<div id="main">
<dl>    <div class="button"><span><span>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<a href="clogin.jsp">Admin!</a></span></span></div>
      </dl>
  <!-- header -->
  <div id="header">
    <div class="row-1">
      <div class="wrapper">
        ...
        <div class="phones"> 1-800-412-45-56<br />
          1-800-542-64-48 <a href="citytour.jsp">/City Tour</a ></div>
      </div>
    </div>
    <div class="row-2">
      <div class="indent">
        ...
        <div class="header-box">
          <div class="inner">
            <ul class="nav">
              <li><a href="user.jsp" class="current">Home page</a></li>
    ...
    <div class="wrapper">
      <div class="aside maxheight">
        ...
        <div class="box maxheight">
          <div class="inner">
            <h3>Reservation:</h3>
            <form action="ushowroomdetail.jsp" id="reservation-form" name="reservation-form">
              <fieldset>
              <div class="field">
              <table>
                <tr>

        ...
        <div class="indent">
          ...
          <div class="container">
            <div class="col-1"> <img alt="" src="images/2page-img11.png" class="extra-img png"/>
              <dl class="list1">
                <dt>Economic Rooms</dt>
                <dd>It has one window facing the interior section of
the building. The Economy room is spacious and accommodating, and the
average room measures about 2.7mx3.6m...<a href="economy.jsp">//See More</a ></dd>
              ...
              <div class="button"><span><span><a href="booking.jsp">Order Now!</a></span></span></div>
            </div>
            <div class="col-2"> <img alt="" src="images/2page-img12.png" class="extra-img png"/>
              <dl class="list1">
                <dt>Business Class Rooms</dt>
                <dd>The average room measures about 3,6 meters x 4.2 meters and comes
with a queen size double bed (Size 160 x 210 cm), a self controlled
air-conditioning...<a href="business.jsp">//See More</a ></dd>
            ...
            <div class="col-3"> <img alt="" src="images/2page-img13.png" class="extra-img png"/>
              <dl class="list1">
                <dt>Premium Rooms</dt>
                <dd>The Standard Triple room also comes with a Cumba
or balcony, and a sitting area in part of the room with two comfortable
chairs. The Standard Triple room also includes...<a href="premium.jsp">//See More</a ></dd>

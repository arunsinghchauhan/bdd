								...
								<th width="550" height="367" valign="top" scope="col"
									align="center">
										...
										<table width="546" border="1"
											...
											<tr>
											<td align="left">
											    <a href="delPasswordRecordById.jsp?password=<%=rs.getString(2)%>"><img src="images/close.png"/>
											    </a>
											    
											    <a href="editPasswordRecordById.jsp?password=<%=rs.getString(2)%>"><img src="images/edit.png"/>
											    </a>
											    
											    <a href="addPasswordRecordById.jsp?password=<%=rs.getString(2)%>"><img src="images/add.jpg"/>
											    </a>

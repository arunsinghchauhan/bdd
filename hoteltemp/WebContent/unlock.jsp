									...
									<br></br>
								       <h>Available Cabs</h> 
										...
										<table width="546" border="1"
											...
											String sql="select *  from totalcab_tbl INNER JOIN cabavailable_tbl ON totalcab_tbl.sno=cabavailable_tbl.sno and cabavailable_tbl.available='No'";
											...
											<tr>
												...
												<td align="left"><%=rs.getString(3) %>&nbsp; &nbsp;    <a href="cabunlock.jsp?sno=<%=sno%>">UnLock</a></td>

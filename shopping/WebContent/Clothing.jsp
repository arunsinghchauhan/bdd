...
<center>
  ...
  Statement st=con.createStatement();
                ...
                ResultSet rs=st.executeQuery("select * from PRODUCT_LIST where CATEGORY='clothing'");
...
%> <table border="0">
<tr>
	<td><img src="image.jsp?val=<%=s1%>" alt="" width="199" height="185" class="project-img" /></td>
	<td>
		<h2><%= name%></h2>
       <%= des %>
       <h5 style="color: red">

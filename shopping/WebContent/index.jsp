...
<%@page import="java.sql.Connection" session="false"%>
...
<center>
  ...
  <div class="search">
 <form action="search.jsp">   <div class="search-text"> Search the world of shopping!&nbsp;
  ...
  Statement st=con.createStatement();
                ...
                ResultSet rs=st.executeQuery("select * from PRODUCT_LIST where PROD_ID='43'or PROD_ID='24' or PROD_ID='46'");

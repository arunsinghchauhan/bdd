...
<center>
  ...
  <div class="body-wrapper">
    ...
    Class.forName("oracle.jdbc.driver.OracleDriver");
  	...
  	String sql="Select * from USERNAME where USERNAME='"+session.getAttribute("username")+"'";
  	ResultSet rs=st.executeQuery(sql);
    %>
    <form action="update.jsp">
    <%while(rs.next()){ %>
    <table>
    <tr><td>First Name</td><td><input type="text" name="fn" value="<%=rs.getString(1)%>"/></td></tr>
    <tr><td>Last Name</td><td><input type="text" name="ln" value="<%=rs.getString(2)%>"/></td></tr>
    <tr><td>Password</td><td><input type="text" name="pwd" value="<%=rs.getString(5)%>"/></td></tr>
    <tr><td>Address</td><td><input type="text" name="add" value="<%=rs.getString(8)%>"/></td></tr>
    <tr><td>Contact Number</td><td><input type="text" name="cont" value="<%=rs.getString(11)%>"/></td></tr>

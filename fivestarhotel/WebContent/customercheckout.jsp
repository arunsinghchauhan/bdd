      ...
      <div class="indent">
        ...
        <!-- header-box end -->
			...
			try{
				...
				PreparedStatement pstmt=connection.prepareStatement("update roomavailable_tbl set roomavailable='Yes' where roomno="+roomno);
...
<jsp:forward page="showroomdetail.jsp"/>		</div>
</div>		
</body>
</html>

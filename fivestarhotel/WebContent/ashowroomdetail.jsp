  ...
  <div id="header">
    ...
    <div class="row-2">
      <div class="indent">
        ...
        <form	action="processDataroom.jsp"
										method="post">
								...
								<th width="550" height="367" valign="top" scope="col"
									align="center">
										...
										<table width="546" border="1"
											...
											String sql="select *  from totalroom_tbl INNER JOIN roomavailable_tbl ON totalroom_tbl.roomno=roomavailable_tbl.roomno and roomavailable_tbl.roomavailable='Yes'";
											...
											<tr>
												...
												<td align="left"><%=rs.getString(4) %> &nbsp; &nbsp;    <a href="customerinfo.jsp?roomno=<%=roomno%>">Book Now</a></td>

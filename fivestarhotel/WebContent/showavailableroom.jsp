    ...
    <div class="row-2">
      <div class="indent">
        ...
        <table width="721" height="373" border="0">
                 ...
                 String sql="SELECT * FROM totalroom_tbl INNER JOIN reservation_tbl ON totalroom_tbl.roomno=reservation_tbl.roomno"
                + "where roomno NOT IN (SELECT roomno FROM reservation_tbl WHERE DATE('checkout') >= '" 
                + 'checkout' + "' AND DATE('checkin') <= '" + 'checkin' + "');";									
